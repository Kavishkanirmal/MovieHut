...
class _AiringTodayTvPageState extends State<AiringTodayTvPage> {
  List airingTodayTv = []; //List to store the movies
...
//Function to fetch the data from the API
  loadMovies() async {
    ...
    Map topRatedMovieResults = await tmdbWithCustomLogs.v3.tv.getAiringToday();
            ...
            Flexible(
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: airingTodayTv.length, //Set the item count
                    ...
                    return InkWell(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => DescriptionPage(
                              name: airingTodayTv[index]['original_name'],
                              bannerurl: 'https://image.tmdb.org/t/p/w500' +
                                  airingTodayTv[index]['backdrop_path'],
                              posterurl: 'https://image.tmdb.org/t/p/w500' +
                                  airingTodayTv[index]['poster_path'],
                              description: airingTodayTv[index]['overview'],
                              vote: (airingTodayTv[index]['vote_average']
                                  .toString()),
                              launchedDate: airingTodayTv[index]
                                  ['first_air_date'],
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                              airingTodayTv[index]['poster_path'] != null
                                  ? 'https://image.tmdb.org/t/p/w500${airingTodayTv[index]['poster_path']}'
                        ...
                        child: Container(
                          ...
                          child: Center(
                            ...
                            child: Text(
                              airingTodayTv[index]['original_name'] != null
                                  ? airingTodayTv[index]['original_name']
                                  : 'Loading..',
