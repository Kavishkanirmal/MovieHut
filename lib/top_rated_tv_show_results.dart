...
class _TopRatedTvPageState extends State<TopRatedTvPage> {
  List topRatedTv = []; //List to store the movies
...
//Function to fetch the data from the API
  loadMovies() async {
    ...
    Map topRatedMovieResults = await tmdbWithCustomLogs.v3.tv.getTopRated();
            ...
            Flexible(
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: topRatedTv.length, //Set the item count
                    ...
                    return InkWell(
                          ...
                          MaterialPageRoute(
                            builder: (context) => DescriptionPage(
                              ...
                              vote: (topRatedTv[index]['vote_average']
                                  .toString()),
                              launchedDate: topRatedTv[index]['first_air_date'],
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                              topRatedTv[index]['poster_path'] != null
