...
class _OnTheAirTvPageState extends State<OnTheAirTvPage> {
  List onTheAirTv = []; //List to store the movies
...
//Function to fetch the data from the API
  loadMovies() async {
    ...
    Map topRatedMovieResults = await tmdbWithCustomLogs.v3.tv.getOnTheAir();
            ...
            Flexible(
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: onTheAirTv.length, //Set the item count
                    ...
                    return InkWell(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => DescriptionPage(
                              name: onTheAirTv[index]['original_name'],
                              bannerurl: 'https://image.tmdb.org/t/p/w500' +
                                  onTheAirTv[index]['backdrop_path'],
                              posterurl: 'https://image.tmdb.org/t/p/w500' +
                                  onTheAirTv[index]['poster_path'],
                              description: onTheAirTv[index]['overview'],
                              vote: (onTheAirTv[index]['vote_average']
                                  .toString()),
                              launchedDate: onTheAirTv[index]['first_air_date'],
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                              onTheAirTv[index]['poster_path'] != null
                                  ? 'https://image.tmdb.org/t/p/w500${onTheAirTv[index]['poster_path']}'
                        ...
                        child: Container(
                          ...
                          child: Center(
                            ...
                            child: Text(
                              onTheAirTv[index]['original_name'] != null
                                  ? onTheAirTv[index]['original_name']
                                  : 'Loading..',
