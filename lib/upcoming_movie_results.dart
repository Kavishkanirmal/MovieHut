...
class _UpcomingMoviesPageState extends State<UpcomingMoviesPage> {
  List upcomingMovies = []; //List to store the movies
...
//Function to fetch the data from the API
  loadMovies() async {
    ...
    Map topRatedMovieResults = await tmdbWithCustomLogs.v3.movies.getUpcoming();
            ...
            Flexible(
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: upcomingMovies.length, //Set the item count
                          ...
                          MaterialPageRoute(
                            builder: (context) => DescriptionPage(
                              ...
                              vote: (upcomingMovies[index]['vote_average']
                                  .toString()),
                              launchedDate: upcomingMovies[index]
                                  ['release_date'],
